...
enum tipo_fator { F_NUM, F_IDENTIFICADOR, F_BOOL, F_FUNC};
...
void empilhaIDENT (char *token, int var_i, int quantFator, int tipo_op, sub_rotina_t proc, pilha_int *pilha, tabela_simbolos_t ts);
